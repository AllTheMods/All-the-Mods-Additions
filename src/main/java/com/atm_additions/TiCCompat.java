...
public class TiCCompat {
    ...
    public static void initMaterials() {
        ...
        registerMaterial("soldering_alloy", 0xf7e4a1, true, true, Registry.solderingAlloy, new HeadMaterialStats(1000, 7.5F, 7.5F, 3), new HandleMaterialStats(0.7F, 500), new BowStringMaterialStats(0.5F));
    }
